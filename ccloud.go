...
func NewClientWithDefaults(apiKey string, apiSecret string, userAgent string, extraHeaders map[string]string) MetricsClient {
	return NewClient(apiKey, apiSecret, DefaultBaseURL, DefaultRequestTimeout, userAgent, extraHeaders)
}
